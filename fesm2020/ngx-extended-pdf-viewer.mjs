...
import { Component, Injectable, EventEmitter, Input, Output, HostListener, ViewChild, Inject, ChangeDetectionStrategy, ViewEncapsulation, Pipe, NgModule, PLATFORM_ID } from '@angular/core';
...
const _c0$6 = ["root"];
const _c1$2 = ["pdfSecondaryToolbarComponent"];
...
/** @nocollapse */ PdfFindRangeComponent.ɵcmp = /** @pureOrBreakMyCode */ i0.ɵɵdefineComponent({ type: PdfFindRangeComponent, selectors: [["pdf-find-range"]], decls: 1, vars: 1, consts: [["autocomplete", "off", "id", "findRange", "title", "pages to search", "data-l10n-id", "find_range", "name", "search-range-field", 1, "toolbarField", 3, "placeholder"]], template: function PdfFindRangeComponent_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵelement(0, "input", 0);
    } if (rf & 2) {
        i0.ɵɵproperty("placeholder", "pages (e.g. 6-10)");
    } }, styles: ["#findRange[_ngcontent-%COMP%]{margin-right:14px}"] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(PdfFindRangeComponent, [{
        type: Component,
